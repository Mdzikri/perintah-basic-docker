...
docker run --name mongodata --publish 3306:3306 --mount "type=bind,source=(direktory),destination=/var/lib/mysql" -e MYSQL_USER=aushafy -e MYSQL_ROOT_PASSWORD=dzikri mysql
