...
docker container create --name nginxbackup --mount "type=bind,source=direktory,destination=/backup" --mount "type=volume,source=(name volume),destination=/data" nginx
